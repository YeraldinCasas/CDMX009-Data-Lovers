...
function recorrer(item) {
  let obj = {
    id: item.resource.id,
    name:
      item.resource.name[0].given[0] + " " + item.resource.name[0].family[0],
    ...
    address:
      item.resource.address[0].line[0] +
      ", " +
      item.resource.address[0].city +
      ", " +
      item.resource.address[0].state +
      ", " +
      item.resource.address[0].postalCode,
